...
module.exports = {
  ...
  'ringtrail': require('analytics.js-integration-ringtrail')
};

}, {"analytics.js-integration-facebook-conversion-tracking":80,"analytics.js-integration-facebook-custom-audiences":81,"analytics.js-integration-ringtrail":82}],
...
}, {"each":4,"analytics.js-integration":83,"global-queue":84}],
...
}, {"emitter":8,"after":10,"each":93,"analytics-events":94,"fmt":95,"foldl":17,"load-iframe":96,"load-script":97,"to-no-case":98,"next-tick":57,"type":99}],
...
}, {"type":99,"component-type":99,"to-function":74}],
...
}, {"script-onload":100,"next-tick":57,"type":48}],
...
}, {"emitter":8,"domify":101,"each":93,"includes":72}],
...
}, {"analytics.js-integration":83,"global-queue":84,"reduce":102}],
...
/**
 * Expose `Ringtrail` integration.
 */

var Ringtrail = module.exports = integration('Ringtrail')
  .option('apiKey', '')
  .option('apiHost', 'd1hpeyve0g16xt.cloudfront.net');
...
Ringtrail.prototype.initialize = function() {
  var self = this;
  this.ready();
...
Ringtrail.prototype.loaded = function() {
  return true;
};
...
Ringtrail.prototype.onpage = function(page) {
...
Ringtrail.prototype.onidentify = function(identify) {
...
Ringtrail.prototype.ongroup = function(group) {
...
Ringtrail.prototype.ontrack = function(track) {
  var json = track.json();
...
Ringtrail.prototype.onalias = function(alias) {
  var json = alias.json();
...
Ringtrail.prototype.normalize = function(msg) {
...
Ringtrail.prototype.ampId = function(ctx) {
...
Ringtrail.prototype.send = function(path, msg, fn) {
  path = 'r.png';
  ...
  var str = '?' + Object.keys(msg).map(function(k) {
...
Ringtrail.prototype.cookie = function(name, val) {
  var store = Ringtrail.storage();
...
Ringtrail.prototype.referrerId = function(query, ctx) {
